...
def brute_force_fill_knapsack(sack, items):
    ...
    best_value = -1
    # for each combo, add up all the weight and value of the items, and save the best one
    for combo in combos:
        value = 0
        weight = 0
        for item in combo:
        ...
        if weight <= 50 and value > best_value:
            best_value = value
            # this is the combo thats so far the best we have seen, set the backpack to this combo
            sack = combo
